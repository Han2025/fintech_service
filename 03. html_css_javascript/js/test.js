...
// myName, finalResult my_Name 


// let: 같은 이름의 변수를 생성 x
// result;
let num; //num이라는 이름의 변수 선언 빈박스 만듬.
num = 10; //num이라는 박스에 10이라는 자료를 넣음. 자료 할당
...
document.write(num + num2);       // 웹브라우저 hyml 화면에 출력
...
let arrayValues = [80, 3.14, "배열", [1,'신기해', [1,2,3],{배열:'array'}]];
// console.log(stdentScore);
console.log(arrayValues);

// //배열은 순서가 있다. 배열 안에 있는 자료를 꺼내는 방법
// // 0번부터 번호가 순서대로 매겨짐
// // 배열 안의 자료를 꺼내는 방법은 배열 변수명[번호]
// // console.log(stdentScore[1]); // 번호가 0번부터 시작하기 때문에 1번은 70
// console.log(stdentScore[0]); 
// console.log(stdentScore[2]);
// // arrayValues에서 신기해를 출력해 보세요.
// console.log(arrayValues[3][1][2]);
// // arrayValues에서 신기해를 출력해 보세요.
// console.log(arrayValues[3][2]);
// console.log(arrayValues[0,3]);
...
// console.log(numChar);
// const numChar2 = 10 + "stingChar"; // 자바스크립트에서는 숫자와 문자 연산을 하면 자동으로
// console.log(numChar2);

// let strNum = "10";
// num = 10;
// if(num == strNum){    //strNum은 문자지만 숫자형태라서 숫자 10과 비교시 숫자로 자동변환 
//     console.log("같음");
// }

// let strNum2 = "10";
// num = 10;
// if(num === strNum2){    //strNum은 문자지만 숫자형태라서 숫자 10과 비교시 숫자로 자동변환 
//     console.log("같음");
// }else{
//     console.log("다름");
// }
...
// let strNum3 = "10";
// num = 10;
// if(num === Number (strNum3)){  //strNum은 문자지만 숫자형태라서 숫자 10과 비교시 숫자로 자동변환 
//     console.log("같음");
// }else{
//     console.log("다름");
// }
...
// function popup() {
//     window.open('www.naver.com', '팝업', 'width=200', height='100')
// }
